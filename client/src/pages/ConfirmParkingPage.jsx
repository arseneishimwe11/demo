    ...
    try {
      ...
      setError(
        err.response?.data?.message ||
          "Failed to register parking. Please try again."
      );
    } finally {
    ...
    <div className="min-h-screen bg-[rgba(5,5,5,1.00)] text-white">
      ...
      <header className="bg-[rgba(15,15,15,0.6)] border-b border-gray-800">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <Link
            to="/dashboard"
            className="text-2xl font-bold bg-lime-400 bg-clip-text text-transparent"
          >
            ParkEase
          </Link>
        </div>
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center mb-8">
          <Link to="/vehicles" className="mr-4 text-gray-400 hover:text-white">
            <FaArrowLeft />
          </Link>
          <div>
            <h1 className="text-3xl font-bold mb-2">Confirm Parking</h1>
            <p className="text-gray-400">
              Review and confirm your parking details
            </p>
          </div>
        </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-300 mb-1">
                    Plate Number:{" "}
                    <span className="text-white">{vehicle?.plateNumber}</span>
                  </p>
                  <p className="text-gray-300 mb-1">
                    Make & Model:{" "}
            ...
            <div className="p-6 border-b border-gray-800">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-300 mb-1">
                    Name:{" "}
                    <span className="text-white">{parkingLocation?.name}</span>
                  </p>
                  <p className="text-gray-300 mb-1">
                    Address:{" "}
                    <span className="text-white">
                  ...
                  <p className="text-gray-300">
                    Available Spaces:{" "}
                    <span className="text-white">
                      {parkingLocation?.availableSpaces} /{" "}
                      {parkingLocation?.totalSpaces}
                    </span>
                  </p>
                  <p className="text-gray-300">
                    Parking Type:{" "}
                    <span className="text-white">{parkingLocation?.type}</span>
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-300 mb-1">
                    Rate:{" "}
                    <span className="text-white">
                      ${parkingLocation?.feePerHour} per hour
                    </span>
                  </p>
                  <p className="text-gray-300 mb-4">
                    Payment will be calculated based on your actual parking
                    duration.
                  </p>

                  <div className="bg-lime-400/10 border border-lime-400/30 rounded p-3 text-sm">
                    <p className="text-lime-400">
                      Note: Your parking session will start immediately upon
                      confirmation.
                    </p>
                  </div>
                </div>
