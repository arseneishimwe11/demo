...
const DashboardLayout = () => {
  ...
  const adminNavigation = [
    ...
    { name: 'Parking Lots', path: '/admin/parking-lots', icon: 'map-pin' },
    { name: 'Parking Slots', path: '/admin/slots', icon: 'grid' },
    { name: 'Bookings', path: '/admin/bookings', icon: 'calendar' },
    { name: 'Users', path: '/admin/users', icon: 'users' },
    { name: 'Pricing', path: '/admin/pricing', icon: 'dollar-sign' },
      ...
      case 'car':
        return (
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
            ...
            <path d="M3 4a1 1 0 00-1 1v10a1 1 0 001 1h1.05a2.5 2.5 0 014.9 0H10a1 1 0 001-1v-1h3a1 1 0 001-1v-3.05a2.5 2.5 0 010-4.9V4a1 1 0 00-1-1H3zm9.5 8.5a1.5 1.5 0 100-3 1.5 1.5 0 000 3z" />
          </svg>
        );
      case 'credit-card':
        return (
  ...
  return (
    <div className="min-h-screen bg-[rgba(5,5,5,1.00)] text-white">
      ...
      <div className={`fixed inset-0 z-40 lg:hidden ${sidebarOpen ? 'block' : 'hidden'}`}>
        ...
        <div className="fixed inset-y-0 left-0 w-64 bg-[rgba(10,10,10,1.00)] overflow-y-auto">
          <div className="flex items-center justify-between p-4 border-b border-gray-800">
            <Link to="/" className="text-2xl font-bold text-lime-400">ParkEase</Link>
      ...
      <div className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col">
        <div className="flex flex-col flex-grow bg-[rgba(10,10,10,1.00)] overflow-y-auto">
      ...
      <div className="lg:pl-64">
        <div className="sticky top-0 z-10 flex items-center justify-between h-16 px-4 bg-[rgba(10,10,10,0.8)] backdrop-blur-sm border-b border-gray-800">
          <button
          ...
          <div className="flex-1 flex justify-center lg:justify-end">
            <div className="w-full max-w-lg lg:max-w-xs">
              <div className="relative">
                ...
                <input
                  className="block w-full pl-10 pr-3 py-2 border border-gray-700 rounded-md bg-[rgba(15,15,15,0.6)] text-white placeholder-gray-400 focus:outline-none focus:border-lime-400 sm:text-sm"
                  placeholder="Search..."
                  type="search"
                />
              </div>
